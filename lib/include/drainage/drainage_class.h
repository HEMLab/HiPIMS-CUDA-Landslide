...
namespace GC{
	...
	public:
        ...
        void  synchronism (int num_Pipe)
        {
        	cudaMemcpy(t_pipe, t_pipe_device, totalCellNum*sizeof(double), cudaMemcpyDeviceToHost);
		    cudaMemcpy(h_p_out, h_p_device, totalCellNum*sizeof(double), cudaMemcpyDeviceToHost);
		    cudaMemcpy(A_p_out, A_p_device, totalCellNum*sizeof(double), cudaMemcpyDeviceToHost);
		    cudaMemcpy(Q_p_out, Q_p_device, totalCellNum*sizeof(double), cudaMemcpyDeviceToHost);
		    // for (int i=0;i<pipeVariables.totalCellNum;i++)
		    // {
		    //   printf("pipeVariables.h_p_out[%d]= %f\n",i , pipeVariables.h_p_out[i]);
		    //   printf("pipeVariables.A_p_out[%d]= %f\n",i , pipeVariables.A_p_out[i]);
		    //   printf("pipeVariables.Q_p_out[%d]= %f\n",i , pipeVariables.Q_p_out[i]);
		    // }


		    cudaMemcpy(pipe_flux_ups1_host, pipe_flux_ups1, num_Pipe*sizeof(double), cudaMemcpyDeviceToHost);
		    cudaMemcpy(pipe_flux_ups2_host, pipe_flux_ups2, num_Pipe*sizeof(double), cudaMemcpyDeviceToHost);
		    cudaMemcpy(pipe_flux_downs1_host, pipe_flux_downs1, num_Pipe*sizeof(double), cudaMemcpyDeviceToHost);
		    cudaMemcpy(pipe_flux_downs2_host, pipe_flux_downs2, num_Pipe*sizeof(double), cudaMemcpyDeviceToHost);
	...
	public:
		...
		void setHostMemory(int num_Junc, int junc_expanValue)
		{
			...
			J_surfExGrid = new int[num_Junc*junc_expanValue];
		}
	...
	public:
		...
		int *surfGrid_device;
		int *surfExGrid_device;  // surface expansion grid index
		...
		void setHostMemory(int num_Junc)
		{
			...
			Qexchange_out = new double[num_Junc];
		}

		void setDeviceMemory(int num_Junc, int junc_expanValue)
		{
			...
			cudaMalloc((void **) &surfExGrid_device, num_Junc*junc_expanValue * sizeof(int));
		...
		void copyCudaMemory(int num_Junc, double *J_elev, double *J_manning, int *J_surfGrid, 
			int * J_surfExGrid, int junc_expanValue, double *J_radius, double *maxDepth)
		{
			...
			cudaMemcpy(surfExGrid_device, J_surfExGrid, num_Junc*junc_expanValue * sizeof(int), cudaMemcpyHostToDevice);
		}


		void synchronism (int num_Junc)
		{
			cudaMemcpy(t_junc, t_junc_device, num_Junc*sizeof(double), cudaMemcpyDeviceToHost);
		    cudaMemcpy(h_j_out, h_j_device, num_Junc*sizeof(double), cudaMemcpyDeviceToHost);
		    cudaMemcpy(Qexchange_device, Qexchange_out, num_Junc*sizeof(double), cudaMemcpyDeviceToHost);
		}
	};
	//******************************************************************************************************************* 
